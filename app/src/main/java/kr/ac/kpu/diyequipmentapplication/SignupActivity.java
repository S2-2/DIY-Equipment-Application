        ...
        authRegisterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (registerEmail.isEmpty() && registerPwd.isEmpty()) {       // 등록할 이메일, 패스워드 미입력인 경우
                    Toast.makeText(SignupActivity.this, "등록할 이메일, 패스워드 입력하세요!", Toast.LENGTH_SHORT).show();
                }
                else if(registerEmail.isEmpty())     //이메일 미입력인 경우
                {
                    Toast.makeText(SignupActivity.this, "등록할 이메일 입력하세요!", Toast.LENGTH_SHORT).show();
                }
                else if (registerPwd.isEmpty())      //패스워드 미입력인 경우
                {
                    Toast.makeText(SignupActivity.this, "등록할 패스워드 입력하세요!", Toast.LENGTH_SHORT).show();
                }
