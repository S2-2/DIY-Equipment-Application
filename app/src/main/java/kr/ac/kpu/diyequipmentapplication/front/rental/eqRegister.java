package kr.ac.kpu.diyequipmentapplication.front.rental;
...
public class eqRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eq_register);
...
// 이때 ListActivity 의 onResume() 함수 가 호출되며, 데이터를 새로 고침
                Toast.makeText(eqRegister.this, "등록되었습니다.", Toast.LENGTH_SHORT).show();
                finish();
            } else {
                Toast.makeText(eqRegister.this, result, Toast.LENGTH_SHORT).show();
            }
